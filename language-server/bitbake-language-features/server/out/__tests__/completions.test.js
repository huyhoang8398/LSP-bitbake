...
describe('On Completion', () => {
    ...
    it('expects reserved variables, keywords and snippets in completion item lists', async () => {
        ...
        const result = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
        ...
        const resultAfterDocScan = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        // Yocto tasks
        expect(resultAfterDocScan).toEqual(expect.arrayContaining([
            {
                documentation: {
        ...
        expect(resultAfterDocScan).not.toEqual(expect.arrayContaining([
            {
                documentation: {
    ...
    it("doesn't provide suggestions when it is in a string content that is not allowed to have completion", async () => {
        analyzer_1.analyzer.analyze({
            uri: fixtures_1.DUMMY_URI,
            document: fixtures_1.FIXTURE_DOCUMENT.COMPLETION
        });
        const result = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
    ...
    it('provides uri suggestions in the SRC_URI', async () => {
        ...
        analyzer_1.analyzer.setRecipeLocalFiles(fixtures_1.DUMMY_URI, recipeLocalFiles);
        const result = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
    ...
    it('provides necessary suggestions when it is in variable expansion', async () => {
        ...
        const result1 = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        // Empty ${}
        const result2 = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(result1).not.toEqual(expect.arrayContaining([
            {
                kind: 14,
                label: 'python'
            }
        ...
        expect(result2).not.toEqual(expect.arrayContaining([
            {
                kind: 14,
                label: 'python'
            }
    ...
    it('provides suggestions for operators when a ":" is typed and it follows an identifier or in the middle of typing such syntax', async () => {
        ...
        const result3 = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        const result4 = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(result3).toEqual(expect.arrayContaining([
            {
                label: 'append',
                kind: 24
            }
        ]));
        expect(result4).toEqual(expect.arrayContaining([
            {
                label: 'append',
                kind: 24
            }
    ...
    it('provides suggestions for overrides when a ":" is typed and it follows an identifier', async () => {
        ...
        BitbakeProjectScannerClient_1.bitBakeProjectScannerClient.bitbakeScanResult._overrides = ['class-target'];
        const result = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
    ...
    it('provides suggestions for direcitive statement after keywords "include", "inherit" and "requrie" are typed', async () => {
        ...
        const resultForInclude = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: documentUri
            },
            position: {
        ...
        const resultForRequire = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: documentUri
            },
            position: {
        ...
        const resultForInherit = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: documentUri
            },
            position: {
        ...
        const resultForInheritDefer = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: documentUri
            },
            position: {
        ...
        expect(resultForInheritDefer).toEqual(expect.arrayContaining([
            expect.objectContaining({
        ...
        expect(resultForInclude).toEqual(expect.arrayContaining([
            expect.objectContaining({
        ...
        expect(resultForRequire).toEqual(expect.arrayContaining([
            expect.objectContaining({
                label: 'init-manager-none.inc',
                kind: 8,
                insertText: 'conf/distro/include/init-manager-none.inc'
        ...
        expect(resultForInherit).toEqual(expect.arrayContaining([
            expect.objectContaining({
                label: 'copyleft_filter',
                kind: 7,
                insertText: 'copyleft_filter'
    ...
    it('provides extra symbols from files in the directive statements', async () => {
        ...
        expect(result).toEqual(expect.arrayContaining([
            expect.objectContaining({
                label: 'DESCRIPTION',
                labelDetails: {
                    description: path_1.default.relative(fixtures_1.FIXTURE_URI.DIRECTIVE.replace('file://', ''), fixtures_1.FIXTURE_URI.FOO_INC.replace('file://', '')) // In this test case, the one that remains after the filtering is the relative path from directive.bb to foo.inc
                }
            })
        ]));
        ...
        expect(result).toEqual(expect.arrayContaining([
            expect.objectContaining({
                label: 'PYTHON',
                labelDetails: {
                    description: path_1.default.relative(fixtures_1.FIXTURE_URI.DIRECTIVE.replace('file://', ''), fixtures_1.FIXTURE_URI.BAR_INC.replace('file://', ''))
                }
            })
        ]));
        BitBakeDocScanner_1.bitBakeDocScanner.parseBitbakeVariablesFile();
        ...
        expect(result2).toEqual(expect.arrayContaining([
            expect.objectContaining({
                label: 'DESCRIPTION',
                labelDetails: {
                    description: path_1.default.relative(fixtures_1.FIXTURE_URI.DIRECTIVE.replace('file://', ''), fixtures_1.FIXTURE_URI.FOO_INC.replace('file://', ''))
                },
                documentation: {
                    value: '```man\nDESCRIPTION (bitbake-language-server)\n\n\n```\n```bitbake\n\n```\n---\n   The package description used by package managers. If not set,\n   `DESCRIPTION` takes the value of the `SUMMARY`\n   variable.\n\n\n[Reference](https://docs.yoctoproject.org/ref-manual/variables.html#term-DESCRIPTION)',
                    kind: 'markdown'
    ...
    it('provides proper completion items on python datastore variables', async () => {
        ...
        const resultOnStringStart = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(resultOnStringStart).toEqual(expect.arrayContaining([
            expect.objectContaining({
                label: 'DESCRIPTION',
                labelDetails: {
                    description: 'Source: Yocto'
        ...
        expect(resultOnStringStart.find((item) => item.label === 'DVAR')).toBeDefined();
        // string_start does not have task among the completion items
        expect(resultOnStringStart).not.toEqual(expect.arrayContaining([
            {
                documentation: {
                    value: '```man\ndo_build (bitbake-language-server)\n\n\n```\n```bitbake\ndo_build(){\n\t# Your code here\n}\n```\n---\nThe default task for all recipes. This task depends on all other normal\ntasks required to build a recipe.\n\n[Reference](https://docs.yoctoproject.org/singleindex.html#do-build)',
                    kind: 'markdown'
        ...
        expect(resultOnStringStart.find((item) => item.label === 'deltask')).toBeUndefined();
        // Completion items on string_content node
        const resultOnStringContent = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(resultOnStringContent).toEqual(expect.arrayContaining([
            expect.objectContaining({
                label: 'DESCRIPTION',
                labelDetails: {
                    description: 'Source: Yocto'
        ...
        expect(resultOnStringContent.find((item) => item.label === 'DVAR')).toBeDefined();
        // string_content does not have task among the completion items
        expect(resultOnStringContent).not.toEqual(expect.arrayContaining([
            {
                documentation: {
                    value: '```man\ndo_build (bitbake-language-server)\n\n\n```\n```bitbake\ndo_build(){\n\t# Your code here\n}\n```\n---\nThe default task for all recipes. This task depends on all other normal\ntasks required to build a recipe.\n\n[Reference](https://docs.yoctoproject.org/singleindex.html#do-build)',
                    kind: 'markdown'
        ...
        expect(resultOnStringContent.find((item) => item.label === 'deltask')).toBeUndefined();
    });
    it('provides proper completion items on variable expansion in bash', async () => {
        ...
        BitBakeDocScanner_1.bitBakeDocScanner.parseBitbakeVariablesFile();
        BitBakeDocScanner_1.bitBakeDocScanner.parseYoctoVariablesFile();
        const resultInVariableExpansion = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(resultInVariableExpansion).toEqual(expect.arrayContaining([
            expect.objectContaining({
                label: 'DESCRIPTION',
                labelDetails: {
                    description: 'Source: Yocto'
        ...
        const resultNotInVariableExpansion = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(resultNotInVariableExpansion.find((item) => item.label === 'DESCRIPTION')).toBeUndefined();
    });
    ...
    it('provides common directories completion items where it is appropriate', async () => {
        ...
        BitBakeDocScanner_1.bitBakeDocScanner.parseYoctoTaskFile();
        BitBakeDocScanner_1.bitBakeDocScanner.parsePythonDatastoreFunction();
        const resultOnVariableExpansion = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(resultOnVariableExpansion.find((item) => item.label === 'FULL_OPTIMIZATION')).toBeDefined();
        ...
        const resultOnPythonDatastoreVariable = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(resultOnPythonDatastoreVariable.find((item) => item.label === 'DEBIAN_MIRROR')).toBeDefined();
        const resultOnVariableAssignation = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(resultOnVariableAssignation.find((item) => item.label === 'DEBIAN_MIRROR')).toBeUndefined();
    });
    ...
    it('Provide proper completion items on LICENSE variable', async () => {
        ...
        const resultBeforeResolve = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(resultBeforeResolve).toEqual(expect.arrayContaining([
        ...
        const resultAfterResolve = await (0, onCompletion_1.onCompletionResolveHandler)(completionItem);
        expect(resultAfterResolve).toEqual(expect.objectContaining({
    ...
    it('Provide proper completion items on LICENSE when operator is expected', async () => {
        ...
        const resultWithoutOperators = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(resultWithoutOperators).not.toEqual(expect.arrayContaining(spdx_licenses_1.licenseOperators));
        const resultWithOperators = await (0, onCompletion_1.onCompletionHandler)({
            textDocument: {
                uri: fixtures_1.DUMMY_URI
            },
            position: {
        ...
        expect(resultWithOperators).toEqual(expect.arrayContaining(spdx_licenses_1.licenseOperators));
    });
    it('Provide proper completion items on LICENSE variable with empty string', async () => {
        analyzer_1.analyzer.analyze({
            uri: fixtures_1.DUMMY_URI,
            document: fixtures_1.FIXTURE_DOCUMENT.COMPLETION
        });
        ...
        expect(result.find((item) => item.label === 'GPL-2.0-with-bison-exception')).toBeDefined();
    });
});
